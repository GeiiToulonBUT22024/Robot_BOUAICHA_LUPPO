...
void InitADC1(void)
{
    ...
    ANSELBbits.ANSB0 = 1;//ExtGauche 
    ANSELBbits.ANSB8 = 1;//Gauche 
    ANSELBbits.ANSB9 = 1;//Centre
    ANSELBbits.ANSB10 = 1;//Droite
    ANSELBbits.ANSB11 = 1;//Extr droirte 

    AD1CSSLbits.CSS0 = 1; // Enable AN22 for scan
    AD1CSSLbits.CSS8 = 1; // Enable AN11 for scan
    AD1CSSLbits.CSS9 = 1; // Enable AN10 for scan
    AD1CSSLbits.CSS10 = 1; // Enable AN9 for scan
