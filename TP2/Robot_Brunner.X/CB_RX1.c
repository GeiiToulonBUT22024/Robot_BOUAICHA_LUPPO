...
int CB_RX1_GetDataSize(void)
{
    ...
    int dataSize;
    dataSize=(CBRX1_BUFFER_SIZE - CB_RX1_GetRemainingSize());
    return dataSize;
}
...
int CB_RX1_GetRemainingSize(void)
{
    ...
    int remainingSize;
     if (cbRx1Head>cbRx1Tail){
         remainingSize=(CBRX1_BUFFER_SIZE-cbRx1Head)+cbRx1Tail;
    }
    else
        remainingSize=(CBRX1_BUFFER_SIZE-cbRx1Tail)+cbRx1Head ;
