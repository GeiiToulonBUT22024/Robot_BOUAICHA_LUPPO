...
static unsigned int ADCResult[5]; // ATTENTION ICI 
unsigned int ADCConversionFinishedFlag;
...
void InitADC1(void)
{
    ...
    AD1CON2bits.SMPI = 4; // 2+1 conversions successives avant interrupt ->  /!\ Changement à 4 puisque passage à 5 télémètres
    AD1CON2bits.ALTS = 0;
    AD1CON2bits.BUFM = 0;
    ...
    AD1CSSLbits.CSS3 = 1; //Enable AN3
    AD1CSSLbits.CSS6 = 1; // Enable AN6 for scan
    AD1CSSLbits.CSS11 = 1; // Enable AN11 for scan
    AD1CSSLbits.CSS15 = 1; // Enable AN15
    AD1CSSHbits.CSS16 = 1; // Enable AN16
    // Enable AN16 for scan
