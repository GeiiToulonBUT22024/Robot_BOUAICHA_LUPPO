...
void InitTimer23(void) {
    ...
    PR2 = 32000; // Load 32-bit period value (lsw)
...
void __attribute__((interrupt, no_auto_psv)) _T3Interrupt(void) {
    ...
    if (LED_BLANCHE == 1){
        //PWMSetSpeedConsigne (80,MOTEUR_DROIT);
        //PWMSetSpeedConsigne (-80,MOTEUR_GAUCHE);
        //PWMSetSpeed(80,MOTEUR_GAUCHE);
